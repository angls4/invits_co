...
<div class="mb-4">
    ...
    <div class="pb-4 text-center">
        <x-button-a href="" class="block w-full mb-3 text-white bg-blue-600 hover:bg-blue-700">
            <span class="">Masuk Melalui Facebook</span>
        </x-button-a>

        <x-button-a href="" class="block w-full text-white bg-red-600 hover:bg-red-700">
