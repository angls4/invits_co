...
<main class="py-6 bg-white grow">
    <div class="container grid gap-5 md:grid-cols-2 2xl:grid-cols-3">
        ...
        <div class="w-full border rounded-md border-brand-purple-300">
            ...
            <x-button-a href="{{ route('admin.themes.index') }}" class="w-full text-white rounded-t-none bg-brand-purple-400 hover:bg-brand-purple-500">View More<i></i></x-button>
        </div>
        <div class="w-full border rounded-md border-brand-purple-300">
            <div class="flex items-center gap-4 p-2.5">
                <div class="grid rounded-md w-28 aspect-square place-items-center bg-brand-purple-500">
            ...
            <x-button-a href="{{ route('admin.orders') }}" class="w-full text-white rounded-t-none bg-brand-purple-400 hover:bg-brand-purple-500">View More<i></i></x-button>
        </div>
        <div class="w-full border rounded-md border-brand-purple-300">
            <div class="flex items-center gap-4 p-2.5">
                <div class="grid rounded-md w-28 aspect-square place-items-center bg-brand-purple-500">
